        ...
        <div>
          ...
          <div className="relative">
            <input 
              ...
              className="w-full bg-[#0E0F19] border border-[#2E305E] focus:border-[#7F4DFF] rounded-xl py-4 pl-4 pr-12 text-gray-100 placeholder-gray-600 outline-none transition-colors"
            />
